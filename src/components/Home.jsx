    ...
    return (
        <div className="bg-hero bg-cover flex justify-center items-center w-screen h-screen ">
            <div className="w-[550px] m-10 bg-dk-blue px-5 py-2 border-solid border-2 border-cyan-400">
                ...
                <div className="flex justify-center mb-5"><input className="w-96 disabled:bg-slate-500 text-black shadow appearance-none border rounded h-7 py-2 px-3 -gray-700 leading-tight focus:outline-none focus:shadow-outline" type="search" onChange={inputHandler}/></div>
